...
?>
<?php
$metaGeneratorContent = 'Nicepage 4.4.3, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'comits' ); ?></a>
    <?php if (!$hideHeader) { ?>
    <header class="u-black u-clearfix u-header u-header" id="sec-8624">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/Screenshot2022-02-14at16.20.38.png",
            'default_url' => "https://nicepage.com"
        )); $url = stripos($logo['url'], 'http') === 0 ? esc_url($logo['url']) : $logo['url']; ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo $url; ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="1630" data-image-height="1080">
